...
$('.login-or-register').click(function(){
	...
	if(text == 'Login or Register'){
		...
		if(confirm('是否退出登录')){
			...
			window.location.href = 'http://192.168.97.218:3001/main.html'
		}
		else{
			return false
		}
...
var dnav = new Vue({
	...
	data:{
		navdata:{
			...
			shop:['Grid Fullwidth','Grid Left Sidebar','Grid Bannerslider','Shop List'],
			pages:{
			...
			blogs:{
				...
				blogstyle:['Grid','Masonry','List','List Siderbar'],
...
$('.d-language-drop .d-little-drop-close').click(function(){
	let languageObj = {
				objname:'.d-language-drop',
				marginshow:'0',
				marginhide:'32px',
...
//
$('.d-language-drop .d-language-list').click(function(){
	let languageObj = {
				objname:'.d-language-drop',
				marginshow:'0',
				marginhide:'32px',
